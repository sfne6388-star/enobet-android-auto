...
class OtoLastikServisi {
  static const String _nominatimUrl =
      'https://nominatim.openstreetmap.org/search';

  Future<List<Hizmet>> otoLastikleriGetir({
    required String il,
    ...
    try {
      ...
      throw Exception(
        'Oto lastik verisi alınırken hata oluştu: $e',
      );
    }
  }
...
(
  nwr["shop"="tyres"]$alan;
  nwr["shop"="car_repair"]["service:vehicle:tyres"]$alan;
  nwr["service:vehicle:tyres"]$alan;
  nwr["tyres"]$alan;
  nwr["name"~"lastik|oto lastik|lastikçi|lastikci|tyre|tire|wheel|jant",i]$alan;
);
out body center;
''';
...
(
  nwr["shop"="tyres"](area.ilceArea);
  nwr["shop"="car_repair"]["service:vehicle:tyres"](area.ilceArea);
  nwr["service:vehicle:tyres"](area.ilceArea);
  nwr["tyres"](area.ilceArea);
  nwr["name"~"lastik|oto lastik|lastikçi|lastikci|tyre|tire|wheel|jant",i](area.ilceArea);
);
...
''';
  ...
  Future<List<Hizmet>> _sorguyuCalistir({
    ...
    for (final dynamic element in elements) {
      ...
      final String id =
          'oto_lastik_${element['type']}_${element['id']}';
