...
class CekiciServisi {
  ...
  Future<List<Hizmet>> cekicileriGetir({
    required String il,
    ...
    try {
      ...
      throw Exception(
        'Çekici verisi alınırken hata oluştu: $e',
      );
    }
  }
...
[out:json][timeout:45];
(
  nwr["service:vehicle:towing"]$alan;
  nwr["service:towing"]$alan;
  nwr["towing"]$alan;
  nwr["amenity"="car_repair"]["name"~"çekici|cekici|oto kurtarma|yol yardım|yol yardim|towing",i]$alan;
  nwr["shop"="car_repair"]["name"~"çekici|cekici|oto kurtarma|yol yardım|yol yardim|towing",i]$alan;
  nwr["name"~"çekici|cekici|oto kurtarma|yol yardım|yol yardim|towing|tow truck|roadside assistance",i]$alan;
);
out body center;
''';
...
(
  nwr["service:vehicle:towing"](area.ilceArea);
  nwr["service:towing"](area.ilceArea);
  nwr["towing"](area.ilceArea);
  nwr["amenity"="car_repair"]["name"~"çekici|cekici|oto kurtarma|yol yardım|yol yardim|towing",i](area.ilceArea);
  nwr["shop"="car_repair"]["name"~"çekici|cekici|oto kurtarma|yol yardım|yol yardim|towing",i](area.ilceArea);
  nwr["name"~"çekici|cekici|oto kurtarma|yol yardım|yol yardim|towing|tow truck|roadside assistance",i](area.ilceArea);
);
...
''';
  ...
  Future<List<Hizmet>> _sorguyuCalistir({
    ...
    for (final dynamic element in elements) {
      ...
      final String id =
          'cekici_${element['type']}_${element['id']}';
