...
class VeterinerServisi {
  ...
  Future<List<Hizmet>> veterinerleriGetir({
    required String il,
    ...
    try {
      ...
      throw Exception(
        'Veteriner verisi alınırken hata oluştu: $e',
      );
    }
  }
...
[out:json][timeout:45];
(
  nwr["amenity"="veterinary"]$alan;
  nwr["healthcare"="veterinary"]$alan;
  nwr["veterinary"]$alan;
  nwr["shop"="pet"]["name"~"veteriner|veterinary",i]$alan;
  nwr["name"~"veteriner|veterinary|veterinary clinic|hayvan hastanesi|hayvan kliniği|hayvan klinigi",i]$alan;
);
out body center;
''';
...
(
  nwr["amenity"="veterinary"](area.ilceArea);
  nwr["healthcare"="veterinary"](area.ilceArea);
  nwr["veterinary"](area.ilceArea);
  nwr["shop"="pet"]["name"~"veteriner|veterinary",i](area.ilceArea);
  nwr["name"~"veteriner|veterinary|veterinary clinic|hayvan hastanesi|hayvan kliniği|hayvan klinigi",i](area.ilceArea);
);
...
''';
  ...
  Future<List<Hizmet>> _sorguyuCalistir({
    ...
    for (final dynamic element in elements) {
      ...
      final String id =
          'veteriner_${element['type']}_${element['id']}';
